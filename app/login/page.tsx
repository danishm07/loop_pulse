      ...
      <div className="max-w-md w-full space-y-8 p-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-bold tracking-tight">
            Sign in to Loop Pulse
          </h2>
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Access your Chicago culture dashboard
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-black focus:outline-none focus:ring-1 focus:ring-black dark:bg-black dark:border-gray-700"
